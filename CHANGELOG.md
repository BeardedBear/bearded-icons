...
- Fix bicepparam extension files [Thanks nahlian](https://github.com/BeardedBear/bearded-icons/issues/138)
...
- Improve folders readability [Thanks kud](https://github.com/BeardedBear/bearded-icons/issues/109)
...
- Add Crystal icon [Thanks my friend papey](https://github.com/BeardedBear/bearded-icons/issues/98)
...
- Add Godot icons [Thanks tpolito](https://github.com/BeardedBear/bearded-icons/issues/63)
...
- Add different icons for image formats
...
- Improve readability for .toml icon
- Change readme icon
